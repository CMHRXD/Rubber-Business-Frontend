...
export const TableClient = () => {
  ...
  const { clients,editClient,deleteClient,addToCart } = useClients();
                      ...
                      if (cell.column.Header === 'Opciones') {
                        return (
                          <td key={cell.value} className="text-center">
                            <a className="font-medium text-blue-600 dark:text-blue-500 hover:underline hover:cursor-pointer" onClick={() => editClient(cell.value)}>Editar</a><br />
                            <a className="font-medium text-red-600 dark:text-red-500 hover:underline hover:cursor-pointer" onClick={() => deleteClient(cell.value)}>Eliminar</a><br />
                            <a className="font-medium text-green-600 dark:text-green-500 hover:underline hover:cursor-pointer" onClick={() => addToCart(cell.value)}>Seleccionar</a>
                          </td>
                        )
                      }
                      return (
